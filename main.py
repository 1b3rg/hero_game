...
# roomId is a list?
# e.g. roomId N = 1, S = 0, E = 3, Desc = "The room was empty ..", Monster = Monster etc
# the number following the compass direction e.g. N, S, E, W is the room that the exit in that compass direction leads
# e.g. head north leads to room 1, roomId is set to 1

# hLife (Hero Life) = 10
# hArm (Hero Armour) = 2
# armour is a number from 0 to 10, 0 being the easiest to hit and 10 being the hardest
...
# if the room contains a monster then event = Combat else the event is set to Other

# event
# =====
# each event has its own set of actions, effects, results, end of event, end of game
...
# If heroTurn is FALSE i.e. its the Monster's turn, then always set to Action to Attack
...
# ------
# Check hit or miss
# to check hit, the attacker roles a 1d10 (add modifiers later e.g. strength, potions, rings etc)
